...
public class Ovale extends Forme {
	...
	public Ovale(Graphics g, int x1, int x2, int y1, int y2, Color contour, Color remplissage) {
	...
	public void tracer(Graphics g) {
		...
		if (super.remplissage == Color.WHITE) {
			...
			g.drawOval(super.x1, super.y1, super.x2, super.y2);		
		} else {
			g.setColor(super.remplissage);
			//CALCULER WIDTH AND HEIGHT DANS LE MOUSSE EVENT
			g.fillOval(super.x1, super.y1, super.x2, super.y2);		
		}
	}
}
